...
class BackendInfo {
    ...
    */
    constructor(objectLocationConstraint, bucketLocationConstraint,
        ...
        this.legacyLocationConstraint = undefined;
        return this;
    }
    ...
    static controllingBackendParam(objectLocationConstraint,
        ...
        this.legacyLocationConstraint =
        BackendInfo.getLegacyLocationConstraint();
        if (BackendInfo.getLegacyLocationConstraint()) {
    ...
    * @param {string | undefined} legacyLocationContraint -
    * legacyLocationContraint
    ...
    */
    getControllingLocationConstraint() {
        ...
        if (this.legacyLocationConstraint) {
            return this.legacyLocationConstraint;
        }
